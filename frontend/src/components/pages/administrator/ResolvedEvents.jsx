...
const ResolvedEvents = () => {
  return (
    <BackEndPage title="Resolved Events">
      <AdminList
        apiData="result"
        apiUrl="/api/v1/cancel-evententertainer?resolved=true"
        pageName="Resolved Event"
        tableRow={ResolvedEventsRow}
      />
    </BackEndPage>
  );
};

const ResolvedEventsRow = ({
  cancelledBy,
  cancelledDate,
  id,
  number,
...
ResolvedEventsRow.defaultProps = {
  cancelledBy: null,
  cancelledDate: null,
